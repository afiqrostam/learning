...
function get_ready(){
  ...
  google.script.run.withSuccessHandler(
    ...
    if(e.s){
      ...
      console.timeEnd(f.f_n);delete f.f_n}
    else{
      console.log(e.con);console.timeEnd(f.f_n);delete f.f_n}}).withUserObject(def).get_batch_data_list(
        {sheet_id:init.sp.settings.id,sheet_range:init.sp.settings.ranges.map(function(e){return e.sheet})})}
